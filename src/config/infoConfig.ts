...
// personal info
export const name = 'Jujie'
export const headline = 'Student at Fudan University.'
export const introduction =
  "Hello! My name is Jujie. I'm from Jiangsu. I’ve been  Computer Science at SCLS since 2020."
export const email = 'tong.hu@scls-sh.org'
export const githubUsername = 'Jujie'
